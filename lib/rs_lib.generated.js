...
// source-hash: 3af2ec7497811695481b7fa2cbd392a6837f1de8
let wasm;
 ...
 * @returns {number}
 */
export function crop_face(data) {
  const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
  const len0 = WASM_VECTOR_LEN;
  const ret = wasm.crop_face(ptr0, len0);
  return ret >>> 0;
}
 ...
 *   exports: { add: typeof add; load_image: typeof load_image; crop_face: typeof crop_face }
 * }>}
 */
...
function getWasmInstanceExports() {
  return { add, load_image, crop_face };
}
